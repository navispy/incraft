...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220324_d0b1d0bbd0bed0b3incraftby_6985dc9cd38dcc649284_20220324104417_archive.zip';
	const ARCHIVE_SIZE		 = '22755642';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6985dc9-24104417';
    const SECONDARY_PACKAGE_HASH = '8820004-24104417';
	const VERSION			 = '1.4.3';
